    ...
    render ()
    {
        return (
            <tr>
                ...
                {this.props.comment.id}
                    {
                        this.props.comment.approved==0?(
                            <span className="tracking-wider text-white bg-red-500 px-4 py-1 text-sm rounded leading-loose mx-2 font-semibold">new</span>
                    ):null}
                </td>
                <td className="px-16 py-2">
                ...
                <td className="px-16 py-2">
                    {this.props.comment.post.title}
                </td>
                <td className="px-16 py-2">
                    {this.props.comment.date_formatted}
                </td>
