                            ...
                            <form className="text-sm m-8 xs:p-4 sm:p-4 md:p-8 lg:p-8" method="post" onSubmit={this.handleSubmit}>
                                <fieldset>
                                    <div className="relative border rounded mb-4 shadow appearance-none label-floating">
                                        <input name="name" type="text" value={this.state.name} className="w-full py-2 px-3 text-black leading-normal rounded" placeholder="Name" onChange={this.handleInput} />
                                        <label className="absolute block text-black top-0 left-0 w-full px-3 py-2 leading-normal">Username</label>
                                        {
                                            this.state.errors && this.state.errors.name?(
                                            <div className="bg-red-lightest border border-red-light text-red-dark pl-4 pr-8 py-3 rounded relative">
                                                <strong className="font-bold">Arfff!</strong>
                                                <span className="block sm:inline">{this.state.errors.name[0]}</span>
                                            </div>):null
                                        }
                                    </div>
                                    <div className="relative border rounded mb-4 shadow appearance-none label-floating">
                                        <input name="email" type="text" value={this.state.email} className="w-full py-2 px-3 text-black leading-normal rounded" placeholder="Email" />
                                    ...
                                    <div className="relative border rounded mb-4 shadow appearance-none label-floating">
                                        <input name="password" type="password" value={this.state.password} className="w-full py-2 px-3 text-black leading-normal rounded" placeholder="Password" onChange={this.handleInput} />
                                    ...
                                    <input type="submit" className="bg-black hover:bg-white hover:text-black text-white w-full py-2 px-4 rounded" value="Register" />
                                </fieldset>
                            </form>
                        </section>
                        <div className="xs:max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg mx-5 my-5">
                            <Link className="text-black font-bold hover:underline" to="/login">Already have account ?</Link>
                        </div>
                    </div>
                </div>
